...
<head>
    ...
    <link rel="stylesheet"  type="text/css" href="css/addcompany2.css">
</head>
    ...
    <div class="container">
            ...
            <div class="box">
                ...
                <form id="register"  method="post">
                    <label>Title:</label>
                    <br />
                   <div class="title"><input type="text" name="title" id="title" value="Graphic design" readonly ></div>
...
if(isset($_POST['submit'])) {
    ...
    sleep(2);
    header('location:graphicdesign.php');
}
?>
